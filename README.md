...
The packages in the `flex_sync` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy flex_sync --override-release-repository-push-url git@github.com:revyos-ros/flex_sync-release.git` on `Thu, 19 Jun 2025 06:48:38 -0000`
...
- release repository: https://github.com/revyos-ros/flex_sync-release.git
